 ...
 * <h2>Payload Types</h2>
 * <ul>
 *   <li>{@link xyz.bannach.bnnch_sort.network.SortRequestPayload} - Client-to-server request
 *       to sort a specific inventory region</li>
 *   <li>{@link xyz.bannach.bnnch_sort.network.CyclePreferencePayload} - Client-to-server request
 *       to cycle the player's sort preferences</li>
 *   <li>{@link xyz.bannach.bnnch_sort.network.SyncPreferencePayload} - Server-to-client sync
 *       of the player's current sort preferences</li>
 * </ul>
 *
 * <h2>Registration</h2>
 * <p>All payloads are registered in {@link xyz.bannach.bnnch_sort.network.ModPayloads}
