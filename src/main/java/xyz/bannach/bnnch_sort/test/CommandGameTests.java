...
public class CommandGameTests {
    ...
    public static void command_sortinv_main_sorts_main_inventory(GameTestHelper helper) {
        ...
        helper.assertTrue(
                player.getInventory().getItem(9).is(Items.APPLE),
                "Slot 9 should be Apple after sorting"
        );
        helper.assertTrue(
        ...
        helper.assertTrue(
                ...
                "Slot 11 should be Stone after sorting"
        );
    ...
    public static void command_sortinv_hotbar_sorts_hotbar(GameTestHelper helper) {
        ...
        helper.assertTrue(
                ...
                "Slot 0 should be Apple after sorting"
        );
        helper.assertTrue(
        ...
        helper.assertTrue(
                player.getInventory().getItem(2).is(Items.STONE),
                "Slot 2 should be Stone after sorting"
        );
    ...
    public static void command_change_updates_player_preference(GameTestHelper helper) {
        ...
        helper.assertTrue(
                updated.method() == SortMethod.QUANTITY,
                "Method should be QUANTITY"
        );
        helper.assertTrue(
                updated.order() == SortOrder.DESCENDING,
    ...
    public static void command_reset_restores_defaults(GameTestHelper helper) {
        ...
        helper.assertTrue(
                pref.method() == Config.defaultSortMethod,
                "Method should be reset to config default"
        );
        helper.assertTrue(
                pref.order() == Config.defaultSortOrder,
                "Order should be reset to config default"
        );
    ...
    public static void command_sorting_uses_player_preference(GameTestHelper helper) {
        ...
        player.setData(ModAttachments.SORT_PREFERENCE, new SortPreference(SortMethod.QUANTITY, SortOrder.ASCENDING));
        ...
        // Verify sorted by quantity ascending (highest count first due to quantity comparator implementation)
        helper.assertTrue(
                player.getInventory().getItem(9).getCount() == 64,
                "Slot 9 should have count 64 (highest)"
        );
        helper.assertTrue(
    ...
    public static void command_invalid_method_is_rejected(GameTestHelper helper) {
        ...
        helper.assertTrue(parseMethod("alphabetical") == SortMethod.ALPHABETICAL, "alphabetical should parse");
