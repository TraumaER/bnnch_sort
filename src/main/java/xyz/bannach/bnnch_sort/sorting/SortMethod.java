 ...
 *
 * <p>Each sort method corresponds to a different {@link java.util.Comparator} implementation in the
 * {@link xyz.bannach.bnnch_sort.sorting.comparator} package.
 *
 * <h2>Side: Common</h2>
 *
...
public enum SortMethod implements StringRepresentable {
   ...
   *
   * <p>Used for NBT persistence and network communication.
   */
  public static final com.mojang.serialization.Codec<SortMethod> CODEC =
      StringRepresentable.fromEnum(SortMethod::values);
   ...
   *
   * <p>The cycle order is: ALPHABETICAL → CATEGORY → QUANTITY → MOD_ID → ALPHABETICAL
   *
