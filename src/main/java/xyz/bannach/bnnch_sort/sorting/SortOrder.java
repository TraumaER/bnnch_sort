 ...
 *
 * <p>Sort order determines whether items are arranged in normal order (ascending) or reversed order
 * (descending) after sorting.
 *
 * <h2>Side: Common</h2>
 *
...
public enum SortOrder implements StringRepresentable {
   ...
   */
  public static final com.mojang.serialization.Codec<SortOrder> CODEC =
   ...
   *
   * @return {@link #DESCENDING} if this is {@link #ASCENDING}, or {@link #ASCENDING} if this is
   *     {@link #DESCENDING}
   */
