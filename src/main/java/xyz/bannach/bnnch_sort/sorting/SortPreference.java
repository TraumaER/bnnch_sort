 ...
 *
 * <p>A SortPreference combines a {@link SortMethod} and {@link SortOrder} to define how items
 * should be sorted. Instances are immutable; modification methods return new instances with the
 * updated values.
 *
 * <h2>Persistence</h2>
 *
 ...
 * <h2>Side: Common</h2>
 *
 * <p>Used on both client and server for preference storage and sorting operations.
 *
...
public record SortPreference(SortMethod method, SortOrder order) {
   ...
   */
  public static final SortPreference DEFAULT =
      new SortPreference(SortMethod.ALPHABETICAL, SortOrder.ASCENDING);
   ...
   *
   * <p>The cycling pattern toggles order first, then advances method when wrapping from DESCENDING
   * to ASCENDING. This creates the sequence:
   *
   * <pre>
