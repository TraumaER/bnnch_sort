 ...
 *
 * <p>This comparator uses case-insensitive string comparison on the item's hover name (display
 * name). It serves as both a primary comparator for alphabetical sorting and as a tiebreaker for
 * other comparators.
 *
 * <h2>Usage</h2>
 *
...
public class AlphabeticalComparator implements Comparator<ItemStack> {
   ...
   *
   * <p>Comparison is case-insensitive and based on the localized display name returned by {@link
   ...
   *     alphabetically less than, equal to, or greater than the second
   */
  @Override
  public int compare(ItemStack a, ItemStack b) {
    return String.CASE_INSENSITIVE_ORDER.compare(
        a.getHoverName().getString(), b.getHoverName().getString());
  }
}
