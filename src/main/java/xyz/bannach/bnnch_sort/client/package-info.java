 ...
 * <ul>
 *   <li>{@link xyz.bannach.bnnch_sort.client.SortButton} - The sort button UI widget
 *       injected into container screens</li>
 *   <li>{@link xyz.bannach.bnnch_sort.client.ScreenButtonInjector} - Injects sort buttons
 *       into supported container screens (chests, shulker boxes, player inventory)</li>
 *   <li>{@link xyz.bannach.bnnch_sort.client.SortKeyHandler} - Manages keybindings for
 *       sorting (R key) and preference cycling (P key)</li>
 *   <li>{@link xyz.bannach.bnnch_sort.client.ClientPreferenceCache} - Caches the player's
 *       sort preferences locally for UI display</li>
 *   <li>{@link xyz.bannach.bnnch_sort.client.SortFeedback} - Displays overlay messages
 *       when sorting or changing preferences</li>
 *   <li>{@link xyz.bannach.bnnch_sort.client.ClientEvents} - Handles screen events for
 *       rendering and input processing</li>
 *   <li>{@link xyz.bannach.bnnch_sort.client.ClientModBusEvents} - Registers keybindings
