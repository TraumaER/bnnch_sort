...
public class ModCommands {
    ...
    private static int executeSortInv(CommandContext<CommandSourceStack> context, String region) {
        ...
        context.getSource().sendSuccess(() -> Component.translatable(
                "command.bnnch_sort.sortinv.success",
    ...
    private static int executeHelp(CommandContext<CommandSourceStack> context) {
        ...
        context.getSource().sendSuccess(() -> Component.translatable("command.bnnch_sort.help.header"), false);
        context.getSource().sendSuccess(() -> Component.translatable("command.bnnch_sort.help.sortinv"), false);
        context.getSource().sendSuccess(() -> Component.translatable("command.bnnch_sort.help.change"), false);
        context.getSource().sendSuccess(() -> Component.translatable("command.bnnch_sort.help.reset"), false);
        context.getSource().sendSuccess(() -> Component.translatable("command.bnnch_sort.help.config"), false);
        context.getSource().sendSuccess(() -> Component.translatable(
    ...
    private static int executeChange(CommandContext<CommandSourceStack> context) {
        ...
        if (method == null) {
            context.getSource().sendFailure(Component.translatable("command.bnnch_sort.change.invalid_method"));
            return 0;
        }

        SortOrder order = parseOrder(orderName);
        if (order == null) {
            context.getSource().sendFailure(Component.translatable("command.bnnch_sort.change.invalid_order"));
            return 0;
        }
    ...
    private static int executeConfig(CommandContext<CommandSourceStack> context, String key) {
        if (key == null) {
            context.getSource().sendSuccess(() -> Component.translatable("command.bnnch_sort.config.header"), false);
            context.getSource().sendSuccess(() -> Component.translatable(
