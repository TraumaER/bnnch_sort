 ...
 * <ul>
 *   <li>{@link xyz.bannach.bnnch_sort.server.SortHandler} - Processes sort requests,
 *       determines target slots, and executes the sorting operation</li>
 *   <li>{@link xyz.bannach.bnnch_sort.server.PreferenceHandler} - Handles preference
 *       cycling requests and syncs updated preferences to the client</li>
 *   <li>{@link xyz.bannach.bnnch_sort.server.ServerEvents} - Listens for player login
 *       events to sync preferences on join</li>
 * </ul>
 *
 * <h2>Inventory Regions</h2>
 * <p>The server supports three distinct sorting regions defined in {@link xyz.bannach.bnnch_sort.server.SortHandler}:</p>
 * <ul>
