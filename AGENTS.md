...
# Key Paths
- Main mod entrypoint: `src/main/java/xyz/bannach/betterinventorysorter/Betterinventorysorter.java`
- Mod config: `src/main/java/xyz/bannach/betterinventorysorter/Config.java`
- Assets: `src/main/resources/assets/betterinventorysorter`
...
# Conventions
- Keep mod id `betterinventorysorter` aligned with `mod_id` in `gradle.properties` and `@Mod` in the entrypoint.
